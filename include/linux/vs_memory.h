...
#define vx_acc_swap_usagepage(m, d) \
	vx_acc_page_atomic(m, d, _swap_usage, VLIMIT_SWAP)
...
#define vx_acc_swap_usagepages(m, p) \
	vx_acc_pages_atomic(m, p, _swap_usage, VLIMIT_SWAP)
...
#define vx_swap_usagepages_inc(m)	vx_acc_swap_usagepage(m, 1)
#define vx_swap_usagepages_dec(m)	vx_acc_swap_usagepage(m, -1)
#define vx_swap_usagepages_add(m, p)	vx_acc_swap_usagepages(m, p)
#define vx_swap_usagepages_sub(m, p)	vx_acc_swap_usagepages(m, -(p))
